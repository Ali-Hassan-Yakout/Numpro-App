...
import 'package:numpro/features/false_position/manager/false_position_screen_cubit.dart';
...
class _FalsePositionScreenState extends State<FalsePositionScreen> {
  final cubit = FalsePositionScreenCubit();
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10.h),
                      BlocBuilder<FalsePositionScreenCubit, FalsePositionScreenState>(
