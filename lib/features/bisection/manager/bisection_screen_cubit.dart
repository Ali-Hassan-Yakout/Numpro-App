...
part 'bisection_screen_state.dart';

class BisectionScreenCubit extends Cubit<BisectionScreenState> {
  BisectionScreenCubit() : super(BisectionScreenInitial());
  ...
  void bisection() {
    ...
    do {
      ...
      if (i == 1) {
        table.add('$i ${xl.toStringAsFixed(3)} ${f(xl).toStringAsFixed(3)} ${xu.toStringAsFixed(3)} ${f(xu).toStringAsFixed(3)} ${xrNew.toStringAsFixed(3)} ${f(xrNew).toStringAsFixed(3)} -----');
      }
      else{
        table.add('$i ${xl.toStringAsFixed(3)} ${f(xl).toStringAsFixed(3)} ${xu.toStringAsFixed(3)} ${f(xu).toStringAsFixed(3)} ${xrNew.toStringAsFixed(3)} ${f(xrNew).toStringAsFixed(3)} ${error.abs().toStringAsFixed(3)}');
      }
      i++;
      if (f(xl) * f(xrNew) > 0) {
        xl = xrNew;
