...
import 'package:numpro/features/gauss_elimination/manager/gauss_elimination_screen_cubit.dart';

class GaussEliminationScreen extends StatefulWidget {
  const GaussEliminationScreen({super.key});

  @override
  State<GaussEliminationScreen> createState() => _GaussEliminationScreenState();
}

class _GaussEliminationScreenState extends State<GaussEliminationScreen> {
  final cubit = GaussEliminationScreenCubit();
              ...
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          const Spacer(),
                          BlocBuilder<GaussEliminationScreenCubit,
                              GaussEliminationScreenState>(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () => cubit.gaussElimination(),
