...
import 'package:numpro/features/secant/manager/secant_screen_cubit.dart';
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      TextFormField(
                        cursorColor: primaryText,
                        controller: cubit.initialMinusOneValueController,
                        validator: (value) {
                          if (value!.isEmpty) {
                            return 'Invalid Initial Minus One Value';
                          }
                          return null;
                        },
                        style: TextStyle(
                      ...
                      SizedBox(height: 10.h),
                      BlocBuilder<SecantScreenCubit, SecantScreenState>(
