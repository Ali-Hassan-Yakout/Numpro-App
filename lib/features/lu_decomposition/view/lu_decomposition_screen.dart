...
import 'package:numpro/features/lu_decomposition/manager/lu_decomposition_screen_cubit.dart';

class LuDecompositionScreen extends StatefulWidget {
  const LuDecompositionScreen({super.key});

  @override
  State<LuDecompositionScreen> createState() => _LuDecompositionScreenState();
}

class _LuDecompositionScreenState extends State<LuDecompositionScreen> {
  final cubit = LuDecompositionScreenCubit();
              ...
              children: [
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          const Spacer(),
                          BlocBuilder<LuDecompositionScreenCubit,
                              LuDecompositionScreenState>(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () => cubit.luDecomposition(),
