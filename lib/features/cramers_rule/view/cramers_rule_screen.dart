...
import 'package:numpro/features/cramers_rule/manager/cramers_rule_screen_cubit.dart';

class CramersRuleScreen extends StatefulWidget {
  const CramersRuleScreen({super.key});

  @override
  State<CramersRuleScreen> createState() => _CramersRuleScreenState();
}

class _CramersRuleScreenState extends State<CramersRuleScreen> {
  final cubit = CramersRuleScreenCubit();
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20.h),
                      BlocBuilder<CramersRuleScreenCubit,
                          CramersRuleScreenState>(
